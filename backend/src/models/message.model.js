...
const messageSchema = new mongoose.Schema({
  ...
  senderType: {
    type: String,
    enum: [Constants.USER_ROLES.AI, Constants.USER_ROLES.ADMIN, Constants.USER_ROLES.AGENT, Constants.USER_ROLES.CHECKER],
    default: Constants.USER_ROLES.CHECKER
  },
  content: {
    type: String,
    required: false,
  ...
  //For images, content will be Null and metadata will contain the image URL and message type will be IMAGE
  messageType: {
    type: String,
