      ...
      >
        ...
        {showFilters && (
          <Grid container spacing={2}>
            ...
            <DatePicker startDateString={startDateString} setStartDateString={setStartDateString} endDateString={endDateString} setEndDateString={setEndDateString} setFilters={setFilters} />
            <Grid item xs={12} sm={6} md={4}>
              <FormControl fullWidth size="small">
                ...
                <Select
                  ...
                  label="Franchise"
                  onChange={(e) =>
                    handleFilterChange("franchise", e.target.value)
                  }
                >
            ...
            <Grid item xs={12}>
              ...
              >
                {timeSlabs.map((slab) => {
                  const count =
                    timeSlabCounts.find((s) => s.label === slab.value)?.count ||
                    0;
                  return (
                    <Button
                      key={slab.value}
                      variant={
                        filters.timeSlab === slab.value
                          ? "contained"
                          : "outlined"
                      }
